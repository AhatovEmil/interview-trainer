...
Этапы 0 (каркас), 1 (таксономия), 2 (контент) и 3 (пользователь и выдача) завершены.
Дальше по плану из CLAUDE.md §6: мобильное приложение → офлайн → план перед собесом.
